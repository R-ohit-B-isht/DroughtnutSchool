...
<nav _ngcontent-yld-c49="" class="flex w-full z-10 text-gray-500 flex-wrap top-0 p-4 pt-6 -ml-4 ng-tns-c49-0 fixed bg-white h-screen content-start snipcss-19oCN">
